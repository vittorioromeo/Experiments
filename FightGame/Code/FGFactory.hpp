...
class FGFactory
{
	...
	public:
		...
		Entity& createTestEntity(const Vec2i& mPos, const Vec2i& mSize, const Vec2f& mVel, bool mPlayer);

		Entity& createProjPunch(Body& mParent, const Vec2i& mPos, const Vec2i& mSize, const Vec2f& mVel, float mLife);
};