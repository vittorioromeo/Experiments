...
namespace Lang
{
    ...
    {
        static auto array(ssvu::mkArray("Number", "POpen", "PClose", "OpAdd",
            "OpSub", "OpMul", "OpDiv", "OpMod"));
...
#define CREATE_OP_STRUCT(mName, mOp)                           \
    ...
    {                                                          \
        ...
        inline static std::string getStr() noexcept            \
        {                                                      \
            return SSVPP_TOSTR(mOp);                           \
        }                                                      \
    }
