...
public:
    ...
    inline bool operator==(const BaseAdaptorForwardItr& mRhs) const noexcept
    {
...
template <typename TItr, typename TImpl>
struct BaseAdaptorBidirectionalItr : public BaseAdaptorForwardItr<TItr, TImpl>
{
    inline BaseAdaptorBidirectionalItr(TItr mItr) noexcept
        : BaseAdaptorForwardItr<TItr, TImpl>{mItr}
    {
    }
...
template <typename TItr, typename TImpl>
struct BaseAdaptorRandomItr : public BaseAdaptorBidirectionalItr<TItr, TImpl>
{
    inline BaseAdaptorRandomItr(TItr mItr) noexcept
        : BaseAdaptorBidirectionalItr<TItr, TImpl>{mItr}
    {
    }
    ...
    inline bool operator<(const BaseAdaptorRandomItr& mRhs) const noexcept
    {
        return this->itr < mRhs.itr;
    }
    inline bool operator>(const BaseAdaptorRandomItr& mRhs) const noexcept
...
using CIA_UPtr = BaseAdaptorRandomItr<TItr, AdaptorCastImpl<T>>;
...
{
    template <typename TItr>
    inline static auto make(TItr mItr) noexcept
    {
