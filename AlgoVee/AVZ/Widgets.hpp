...
namespace avz
{
    namespace w
    {
        ...
        public:
            ...
            inline void taColorize(sf::Color& mColor, const sf::Color& mCStart,
                const sf::Color& mCEnd)
            {
        ...
        public:
            ...
            inline void taHightlight()
            {
                taColorize(bgColor, bgColorDef, bgColorHgl);
            }
            inline void taUnhightlight()
            {
                taColorize(bgColor, bgColorHgl, bgColorDef);
            }
        ...
        public:
            ...
            inline void refreshPositions()
            {
                ...
                {
                    tss[i]->tLocal.pos =
                        tss[i - 1]->tLocal.pos + Vec2f{65.f, 0.f};
                }
            }
